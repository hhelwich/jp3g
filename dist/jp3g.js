(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var decode = function (buffer) { return __awaiter(void 0, void 0, void 0, function () {
        var width, height, imageData, y, x;
        return __generator(this, function (_a) {
            ...
            for (y = 0; y < height; y += 1) {
                for (x = 0; x < width; x += 1) {
                    ...
                    imageData.data[y * width * 4 + x * 4 + 1] = Math.floor(Math.random() * 256);
                    imageData.data[y * width * 4 + x * 4 + 2] = Math.floor(Math.random() * 256);
